...
Define budget limits behavior for monthly/category budgeting, including CRUD/archive semantics, invariants, ownership rules, and media-type/error expectations.
